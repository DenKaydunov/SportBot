...
SELECT ad.id, 'ru', 'Творец бессмертия', 'Выполни 1000 тренировок. Дисциплина достигла божественного уровня.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM achievement_definitions ad WHERE ad.code = 'WORKOUT_2500' UNION ALL
