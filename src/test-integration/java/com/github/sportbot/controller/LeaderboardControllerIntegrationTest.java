...
class LeaderboardControllerIntegrationTest {
    ...
    void shouldReturnLeaderboardByPeriod() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/leaderboards/{exerciseCode}/by-period", exerciseCode)
                        .param("limit", "3")
                        .param("period", "today")
    ...
    void shouldReturnLeaderboardByDates() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/leaderboards/{exerciseCode}/by-dates", exerciseCode)
                        .param("tagCode", "TAG")
                        .param("limit", "5")
    ...
    void shouldReturnLeaderboardByDatesPaged() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/api/v1/leaderboards/{exerciseCode}/by-dates/paged", exerciseCode)
                        .param("tagCode", "TAG")
                        .param("page", "1")
                        .param("size", "20")
                        .param("startDate", startDate.toString())
    ...
    void shouldHandleInvalidSortGracefully() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/leaderboards/{exerciseCode}/by-period/paged", exerciseCode)
                        .param("page", "1")
                        .param("size", "10")
                        .param("sort", "string")
                        .param("period", "today")
